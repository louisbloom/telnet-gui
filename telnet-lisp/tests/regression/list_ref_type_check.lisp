...
(condition-case err (list-ref 1 0) (error #t)) ; => #t
; Test 2: list-ref with string should error, not segfault
(condition-case err (list-ref "string" 0) (error #t)) ; => #t
...
(condition-case err (list-ref match-result 0) (error #t)) ; => #t
; Test 4: list-ref with improper list should error gracefully
(condition-case err (list-ref '(1 2 . 3) 2) ; trying to access beyond proper list part
  (error #t)) ; => #t
; Test 5: list-ref with vector should error, not segfault
(condition-case err (list-ref (make-vector 5 0) 0) (error #t)) ; => #t
