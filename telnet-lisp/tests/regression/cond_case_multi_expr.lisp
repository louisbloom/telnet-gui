...
(cond ((= 1 2) "never") (else (set! a 30) (set! b 40)))
...
(case 5 ((1 2 3) "small") ((4 5 6) (set! m 50) (set! n 60)) (else "large"))
...
(case 99 ((1 2 3) "small") (else (set! p 70) (set! q 80)))
...
(do nil ((>= counter 3) result)
  (cond (#t (set! result (concat result "X")) (set! counter (+ counter 1)))))
...
(let ((a 0)
      ...
      (limit 3))
  (do nil ((>= a limit) b)
    (let ((ch "Y")) (cond (#t (set! b (concat b ch)) (set! a (+ a 1)))))))

; => "YYY"
; Test 7: case returns value of last expression
(case 1 ((1) (define temp1 100) (define temp2 200) (+ temp1 temp2)))
