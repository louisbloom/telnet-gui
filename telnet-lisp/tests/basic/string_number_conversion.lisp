...
;; Use with arithmetic
(assert-equal (+ (string->number "10") (string->number "20")) 30
 "add parsed numbers")
(assert-equal (* (string->number "5") (string->number "3")) 15
...
(assert-equal (string->number "-2.5e-3") -0.0025
 "parse negative scientific notation")
(assert-equal (string->number "1.23e+5") 123000.0
...
(assert-equal (number->string 10000000000.0) "10000000000.0"
 "convert large float to string")
;; =============================================================================
;; Round-trip Tests (string->number and number->string)
;; =============================================================================
;; Integers in various bases
(assert-equal (number->string (string->number "1010" 2) 2) "1010"
 "round-trip binary")
(assert-equal (number->string (string->number "ff" 16) 16) "ff"
 "round-trip hex")
(assert-equal (number->string (string->number "77" 8) 8) "77"
 "round-trip octal")
;; Floats
