#!/usr/bin/env python3
"""
telnet-gui-log2html.py - Convert telnet log files to terminal-styled HTML with ANSI rendering

Usage:
    python telnet-gui-log2html.py input1.log [input2.log ...]
    python telnet-gui-log2html.py *.log  # Convert all log files
...
{content}
        <div class="footer">Generated by telnet-gui-log2html.py</div>
    </div>
</body>
</html>
"""
...
def main():
    ...
    for input_file in input_files:
        ...
        # Determine output filename: replace .log extension with .html, or append .html
        base, ext = os.path.splitext(input_file)
        output_file = base + ".html"

        # Convert
        if convert_log_to_html(input_file, output_file):
            success_count += 1
        else:
            error_count += 1
